...
in stdenv.mkDerivation rec {
  ...
  srcs = [
    (fetchFromGitHub {
      ...
      rev = "a5b7d3e845027a360c0d739259a7cfe04c74c2c9";
      sha256 = "1glgvhjk029rycil81cfxbhfy49wiz46783nimh54qhcniayw723";
    ...
    (fetchFromGitHub {
      ...
      repo = "OpenRA" ;
      rev = engine-version;
      sha256 = "13bflvpsdw24ypviyhxpqnx000q9pb5wjwdkr2f37p7pgkb161s2";
      name = "engine";
