...
in {
  ...
  bleed = let commit = "08c472b2e27d0ddcc446a223624d0683c7f4cb69"; in buildUpstreamOpenRAEngine {
    version = "26346.git.08c472b";
    rev = commit;
    sha256 = "0sxjrcgfc0z968jpaiyysc5v30krj7d6rg8lvhqagx0yarz9qmyd";
  };
}
