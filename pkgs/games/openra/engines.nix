...
in {
  ...
  bleed = let commit = "7d72aae5ba4dc881fe76d5a2a5bda958eb503489"; in buildUpstreamOpenRAEngine {
    version = "25735.git.7d72aae";
    rev = commit;
    sha256 = "1baxrd7fhpl6aryy2m1s91yvmvnjgpvb3cladvlm19vxcinckqc6";
  };
}
