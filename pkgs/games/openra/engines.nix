...
in {
  ...
  bleed = let commit = "7f4fbfcf467c3f1223d6f3494e67dcb8b9f902d9"; in buildUpstreamOpenRAEngine {
    version = "26269.git.7f4fbfc";
    rev = commit;
    sha256 = "19llkn27i5h4fqa6w582hdbvy441bmrqnrdgwdnb0zj0wamg6yr4";
  };
}
