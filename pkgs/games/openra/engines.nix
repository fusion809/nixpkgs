...
in {
  ...
  bleed = let commit = "8c7ff3b5b0c7306143d8ebce44444a137f3ce07c"; in buildUpstreamOpenRAEngine {
    version = "26296.git.8c7ff3b";
    rev = commit;
    sha256 = "05hnzbd6b4lyrr62qw4gmr6mdmzji4kryqwvzfyikav942yxaban";
  };
}
