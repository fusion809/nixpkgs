...
in {
  ...
  bleed = let commit = "e23054631dd58453806c608ed46f6ae9943fb1d7"; in buildUpstreamOpenRAEngine {
    version = "26196.git.e230546";
    rev = commit;
    sha256 = "1ymnzc553wmll3a0fn39cpq80k5wdqs8pyrrp9z15b1njj888b6p";
  };
}
