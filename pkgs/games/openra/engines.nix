...
in {
  ...
  bleed = let commit = "b4b3ce68a9730ba40b6401c69c4fd5112aa085f3"; in buildUpstreamOpenRAEngine {
    version = "26223.git.b4b3ce6";
    rev = commit;
    sha256 = "1834xz4jgyilnyynsbacs3p6wjl44c220nab5bzcfkm84fhjzqfq";
  };
}
