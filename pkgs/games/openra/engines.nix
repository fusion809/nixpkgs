...
in {
  ...
  bleed = let commit = "e662f17f067d0b6c2fc14422c380d24e3e0e16ef"; in buildUpstreamOpenRAEngine {
    version = "26276.git.e662f17";
    rev = commit;
    sha256 = "0bpypw2ibygb5yqhwp7a271v9iprcqp032dy1n6j21bd4jk75rrv";
  };
}
