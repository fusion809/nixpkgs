...
in {
  ...
  bleed = let commit = "2912bff850569e941f3a072282de760c8fa9c2cd"; in buildUpstreamOpenRAEngine {
    version = "26224.git.2912bff";
    rev = commit;
    sha256 = "0zkkgxfx1s3x45w788ha8s5kcj0vyqvaw7v8ma37sfhf98dvgn8s";
  };
}
