...
in {
  ...
  bleed = let commit = "ffbee7e45b8381e3f299dd0d14978ea05e18349c"; in buildUpstreamOpenRAEngine {
    version = "25917.git.ffbee7e";
    rev = commit;
    sha256 = "139pylpscmgg0rp3jab5n1djniakzxdvwmw6icdrhd9wcf303vfv";
  };
}
