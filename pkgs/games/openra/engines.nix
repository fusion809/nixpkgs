...
in {
  ...
  bleed = let commit = "79f0bdc65c0f27e120ab0bee620d675102983e71"; in buildUpstreamOpenRAEngine {
    version = "26027.git.79f0bdc";
    rev = commit;
    sha256 = "0g3faq3nby49xxhavxb7qjdbknxkjvp71ad1pim3nqkjnj9c60mb";
  };
}
