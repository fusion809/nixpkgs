...
in {
  ...
  bleed = let commit = "2c24a607bc83e7929bdd373090ffddcbb769242d"; in buildUpstreamOpenRAEngine {
    version = "26348.git.2c24a60";
    rev = commit;
    sha256 = "0010x68xz09hf5jp1y3c8yiz45wckilxx408b39s8k7yxqbz6hyq";
  };
}
