...
in {
  ...
  bleed = let commit = "8690a4a6ce5e595f29f3d5859cb58b6fa9775c4c"; in buildUpstreamOpenRAEngine {
    version = "26327.git.8690a4a";
    rev = commit;
    sha256 = "1vwxyrif3vmzjaagrsa5gmj302n5cxyy5gljlfk9246cyixglg5g";
  };
}
