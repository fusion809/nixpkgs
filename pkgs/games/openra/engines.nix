...
in {
  ...
  bleed = let commit = "36783efbfb17d35c5287ac4f1849578b1f691769"; in buildUpstreamOpenRAEngine {
    version = "25911.git.36783ef";
    rev = commit;
    sha256 = "0c4r4x12dvwlg6gn41f0w9mpz0rkpaq0ndriyvx3y181nh38l0vq";
  };
}
