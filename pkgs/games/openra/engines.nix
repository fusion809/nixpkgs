...
in {
  ...
  bleed = let commit = "760a2b483ee19fead28a2749baf43ab8d1f2cdec"; in buildUpstreamOpenRAEngine {
    version = "26107.git.760a2b4";
    rev = commit;
    sha256 = "1fw7ls05y602z3y6nnc7qdxcbpk0arr4ny9yirb43zz3gqcn4d5g";
  };
}
