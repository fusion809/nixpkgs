...
in {
  ...
  bleed = let commit = "0eb506326000fcb0233a9a9dcb0484ac5b22690e"; in buildUpstreamOpenRAEngine {
    version = "26148.git.0eb5063";
    rev = commit;
    sha256 = "182mzwkkh2ghg4lzidry1x4h1wwxd3lzi4y34gyf3bvhnc3irzr6";
  };
}
