...
in {
  ...
  bleed = let commit = "ed8abe986159c15ababb04fe911d7fc3397826e8"; in buildUpstreamOpenRAEngine {
    version = "26366.git.ed8abe9";
    rev = commit;
    sha256 = "1alyi1h76906kp9nigysq8k08qlyfm3nms30r20p1j8dv0ykvb5k";
  };
}
