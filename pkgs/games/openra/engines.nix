...
in {
  ...
  bleed = let commit = "9a15df9dde46ce7257adf3f15ea401135633cf68"; in buildUpstreamOpenRAEngine {
    version = "25828.git.9a15df9";
    rev = commit;
    sha256 = "119x85qjyz8jl8z7b5r8ia2snc00pvbf2k7mjv8ai9xjxml0q836";
  };
}
