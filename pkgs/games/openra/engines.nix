...
in {
  ...
  bleed = let commit = "702f4d19379c1924054b408cddb608b388c18929"; in buildUpstreamOpenRAEngine {
    version = "26320.git.702f4d1";
    rev = commit;
    sha256 = "1q5g4jrpdy8kgmljsx6a1rzwjqipcmw6gzmn3nb819m8p9fxhpsk";
  };
}
