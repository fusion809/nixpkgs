...
in {
  ...
  bleed = let commit = "739f437c18abcbba8e1400c0fc3afa4e4ca4fcc5"; in buildUpstreamOpenRAEngine {
    version = "26181.git.739f437";
    rev = commit;
    sha256 = "1b08n3ljk53nnj9l5xd1f7clfj3kkks7049xq9mv4vjrwaav8v30";
  };
}
