...
in {
  ...
  bleed = let commit = "d9d220259975f650cd84b92bd59ca122f5c8b24d"; in buildUpstreamOpenRAEngine {
    version = "25950.git.d9d2202";
    rev = commit;
    sha256 = "0kgvn88pkf9f5s5sgdiqq71f13balpjbqi4habzdn6gz9kq1s4jz";
  };
}
