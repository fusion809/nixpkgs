...
in {
  ...
  bleed = let commit = "586fa809431223538971e2c98fae77eb06b6e7c6"; in buildUpstreamOpenRAEngine {
    version = "26136.git.586fa80";
    rev = commit;
    sha256 = "1gnx10mns2prsdabylizhmscklhnzfkdffvs4znl6nijfz377izy";
  };
}
