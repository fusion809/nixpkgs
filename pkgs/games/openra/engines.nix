...
in {
  ...
  bleed = let commit = "840eb7006d27b95932e52e36d381ddbc0ec4ed1a"; in buildUpstreamOpenRAEngine {
    version = "25883.git.840eb70";
    rev = commit;
    sha256 = "17z3shyp4sr0dkfza1pa3c4bnvk068s95fq6r48cw7xrmbn9qamn";
  };
}
