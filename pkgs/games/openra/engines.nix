...
in {
  ...
  bleed = let commit = "151fea9c00f88a0c0c1c22f4e3e1aedc5b0d9f58"; in buildUpstreamOpenRAEngine {
    version = "25826.git.151fea9";
    rev = commit;
    sha256 = "1g8pikja4w06696i4jgmjndybm52x476lzpaw9sg0h67fg2v249q";
  };
}
