...
in {
  ...
  bleed = let commit = "123b3f054ff23a57f63ec614867cda4c890895ec"; in buildUpstreamOpenRAEngine {
    version = "25952.git.123b3f0";
    rev = commit;
    sha256 = "0r4sy2mj2l39464d8hcwlj2xjb2jym47g1brna5073x96q2li0aq";
  };
}
