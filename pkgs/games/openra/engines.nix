...
in {
  ...
  bleed = let commit = "1c6c55092f5f76371ceaada3cc67f7463e5e159b"; in buildUpstreamOpenRAEngine {
    version = "26077.git.1c6c550";
    rev = commit;
    sha256 = "1a4hdr3adnjsypqajywhbq4y2is67mxwpjk1in7dz942gf3g3kj8";
  };
}
