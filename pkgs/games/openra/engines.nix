...
in {
  ...
  bleed = let commit = "63817ae807ff37e9d5e9f797bdd0116b4b8902d0"; in buildUpstreamOpenRAEngine {
    version = "25830.git.63817ae";
    rev = commit;
    sha256 = "12k0xhrwydvqkj1k5q5bkfb569byg42x3ks4j8imzg309zj0yv1z";
  };
}
