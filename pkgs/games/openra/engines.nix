...
in {
  ...
  bleed = let commit = "bf6fa94224a4817a8f7d1d7a183d7144cd2a5bd8"; in buildUpstreamOpenRAEngine {
    version = "26111.git.bf6fa94";
    rev = commit;
    sha256 = "1cjy5yj1nb6gqdhb44529y5bnv0d8ksq9zh0bdbc89barfpq28dm";
  };
}
