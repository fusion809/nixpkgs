...
in {
  ...
  bleed = let commit = "7bbfd823d00a23ca7d092600bce2e19bcd87e8c7"; in buildUpstreamOpenRAEngine {
    version = "26182.git.7bbfd82";
    rev = commit;
    sha256 = "1n6sivh8k88sak25a4915pyvmx25ajr5fllmy76bh67ln4l0lwly";
  };
}
