...
in {
  ...
  bleed = let commit = "30de4df749bf9df43ef5477ea1381024a4e0b0be"; in buildUpstreamOpenRAEngine {
    version = "25833.git.30de4df";
    rev = commit;
    sha256 = "05801m3il3a8h57f5g675ddamlhb24dm5y87dr5kw4sa6nrw7b72";
  };
}
