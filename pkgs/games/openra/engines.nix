...
in {
  ...
  bleed = let commit = "78a70be0d4e55558e8760ad09287ef4acdc26ca8"; in buildUpstreamOpenRAEngine {
    version = "26063.git.78a70be";
    rev = commit;
    sha256 = "1hscaw59yhkix3bm2486dsdr1i38lpx8cs10q38g7s21qg9dlspi";
  };
}
