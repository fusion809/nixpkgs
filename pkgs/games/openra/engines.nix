...
in {
  ...
  bleed = let commit = "fbce22784ba476c94afe47736ee5c0b462cfc289"; in buildUpstreamOpenRAEngine {
    version = "26040.git.fbce227";
    rev = commit;
    sha256 = "1gxzarm77lr3s01wq9kq7yq4j4dmyp7sci6y02fbdr6mmar9mj8y";
  };
}
