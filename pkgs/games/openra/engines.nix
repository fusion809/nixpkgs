...
in {
  ...
  bleed = let commit = "981fe6fae1315adb2fb73fca2452d9a0100a19d3"; in buildUpstreamOpenRAEngine {
    version = "25888.git.981fe6f";
    rev = commit;
    sha256 = "08n06i0d91xk1gj2dvbms3hz3j5mcd17ym9rcjx3lpach3cb11wa";
  };
}
