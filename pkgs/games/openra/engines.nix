...
in {
  ...
  bleed = let commit = "72c90d84a86514588af8daed9502bbe3108f24a6"; in buildUpstreamOpenRAEngine {
    version = "25699.git.72c90d8";
    rev = commit;
    sha256 = "0124hvnyzadzsgnbpnv81snziz6yq4r88aqxlmp728ksy9islsla";
  };
}
