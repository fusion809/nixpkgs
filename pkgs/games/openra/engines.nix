...
in {
  ...
  bleed = let commit = "d9e1a6845352f041144fda156491abed1e1b227f"; in buildUpstreamOpenRAEngine {
    version = "26275.git.d9e1a68";
    rev = commit;
    sha256 = "00xf12xdqxhm4szbd9vwc0q6lwsgl3dq1k7a4kahk5vlmjrdyvmr";
  };
}
