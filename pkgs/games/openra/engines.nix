...
in {
  ...
  bleed = let commit = "2e5e7c22f4e5fd3124d025f3c711348d0da92e98"; in buildUpstreamOpenRAEngine {
    version = "25756.git.2e5e7c2";
    rev = commit;
    sha256 = "1qsnmdwkmyzibwsg6s4zxbryqlrmcy3f58b8jyca8igfrlk26b3v";
  };
}
