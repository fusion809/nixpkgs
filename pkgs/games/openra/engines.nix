...
in {
  ...
  bleed = let commit = "2a9721a9f864cf388d2fc6bd6169791b0d272927"; in buildUpstreamOpenRAEngine {
    version = "25805.git.2a9721a";
    rev = commit;
    sha256 = "15b5xmylw20xaxmwaqq2hd9kdaf8hc39y0hb7yd75ig0sddxvbz7";
  };
}
