...
in {
  ...
  bleed = let commit = "6841da286cc3d0fb01fd0675fc9f70a2cb033f25"; in buildUpstreamOpenRAEngine {
    version = "25698.git.6841da2";
    rev = commit;
    sha256 = "14j3l35icm300wnlz5rwhhmgykjkkn2xpz5wb64y8wjv5c4a59bs";
  };
}
