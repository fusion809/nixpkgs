...
in {
  ...
  bleed = let commit = "e3f868f0a839af8a2ff1b204809f9be7428e9551"; in buildUpstreamOpenRAEngine {
    version = "25969.git.e3f868f";
    rev = commit;
    sha256 = "0fgfvsq1zal3nkyvgsabjhmr6awnf55543narf3nvsw5yiigm5qz";
  };
}
