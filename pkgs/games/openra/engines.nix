...
in {
  ...
  bleed = let commit = "db68c6e2642a212a9caba5fbdfc93aaab5a5ae32"; in buildUpstreamOpenRAEngine {
    version = "25886.git.db68c6e";
    rev = commit;
    sha256 = "10n2j99cjkz61jbh2nl1j7m4qwadj68az730p4dcjjqa8hslbw6s";
  };
}
