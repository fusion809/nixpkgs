...
in {
  ...
  bleed = let commit = "b35dfb50a8849969691b76a4fb15f78c3f652491"; in buildUpstreamOpenRAEngine {
    version = "26210.git.b35dfb5";
    rev = commit;
    sha256 = "14cmxqmmm9mmswcc3wfh0g8p0afpz2ca0k4fwxm18v1ijg0bmn7m";
  };
}
