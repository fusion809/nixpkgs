...
in {
  ...
  bleed = let commit = "83b4e448c8a4bc260ff5538c3fffccf32c1b23ca"; in buildUpstreamOpenRAEngine {
    version = "25990.git.83b4e44";
    rev = commit;
    sha256 = "0kxvsqdf19z7ln3w2y5p3zrzm3j0gzvqk7g190853flqzj92s26l";
  };
}
