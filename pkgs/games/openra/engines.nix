...
in {
  ...
  bleed = let commit = "fbf946189044308f2ef4704a78836535db452116"; in buildUpstreamOpenRAEngine {
    version = "26062.git.fbf9461";
    rev = commit;
    sha256 = "088i97kz0kazkdwcjfb9m3nlmsc4c1sikqsnm6g8874zv68scb27";
  };
}
