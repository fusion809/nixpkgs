...
in {
  ...
  bleed = let commit = "946c9f420bd8e0a5946b1d0513cb9c8924c949ed"; in buildUpstreamOpenRAEngine {
    version = "26372.git.946c9f4";
    rev = commit;
    sha256 = "0v6p1r38njicw7j3dv6282ry4bl2q2gc8fdlq57fkyqb14zdhic1";
  };
}
