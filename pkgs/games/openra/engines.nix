...
in {
  ...
  bleed = let commit = "70459b311e7f3afe41f10901b8cc3a4a1ae20355"; in buildUpstreamOpenRAEngine {
    version = "26351.git.70459b3";
    rev = commit;
    sha256 = "0g9qivr4mhpq04kqbbf3832gyl7cgq8ycmp9pc5n6vj5j4d7rl4k";
  };
}
