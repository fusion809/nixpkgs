...
in {
  ...
  bleed = let commit = "859d01da7dacdc97ca9b9d29617bf570909aaa89"; in buildUpstreamOpenRAEngine {
    version = "26332.git.859d01d";
    rev = commit;
    sha256 = "113n15678drc92a1v0v2c1dy982r6ncczx4wvdkmsw0mnpnhc7yv";
  };
}
