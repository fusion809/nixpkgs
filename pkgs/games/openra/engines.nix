...
in {
  ...
  bleed = let commit = "5e38cfda810368b710b5ff0cf502e57bac242bbb"; in buildUpstreamOpenRAEngine {
    version = "25980.git.5e38cfd";
    rev = commit;
    sha256 = "18sfj6dllqafy9ay5pd691zjnffhqbdsyqlfz31yxrjvp4xh3crc";
  };
}
