...
in {
  ...
  bleed = let commit = "71ed22a473955824b633cb287a853fe8f7814634"; in buildUpstreamOpenRAEngine {
    version = "26178.git.71ed22a";
    rev = commit;
    sha256 = "176faij88r8h41wql5jpb4x8c8gal4cyy3pxvn9nhbvb804hhyg6";
  };
}
