...
in {
  ...
  bleed = let commit = "8589e26dc224aef4c0c549b6d9e1d87f10ca1149"; in buildUpstreamOpenRAEngine {
    version = "26119.git.8589e26";
    rev = commit;
    sha256 = "0994cpjakh578p8bkkqf7p2r1af6nrb45vs5rv2h6vh1haz7kmly";
  };
}
