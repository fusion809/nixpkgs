...
in {
  ...
  bleed = let commit = "4fae77ed1c62ad6fbd1adebe83194b76e7f67be3"; in buildUpstreamOpenRAEngine {
    version = "26100.git.4fae77e";
    rev = commit;
    sha256 = "0s0mikch6xgznqvw20mavzm2jl0ahakm0j5ab4cp9gznwvxrj4iy";
  };
}
