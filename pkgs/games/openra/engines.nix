...
in {
  ...
  bleed = let commit = "7cfc65010f9eb3a5f8f3b4145e918fa8f2419f8f"; in buildUpstreamOpenRAEngine {
    version = "26309.git.7cfc650";
    rev = commit;
    sha256 = "1cspmvxsc99n404gvgsmjbgpwiy9pbq985wb4c41ycl441x3vjhz";
  };
}
