...
in {
  ...
  bleed = let commit = "71596ae959e5ec9701acbb14c905296b3f703737"; in buildUpstreamOpenRAEngine {
    version = "25875.git.71596ae";
    rev = commit;
    sha256 = "1rnq2zlgnqblmb1859rrb911kx5bm66yrz8li0x1ck63khrkxc8g";
  };
}
