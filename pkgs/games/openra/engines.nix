...
in {
  ...
  bleed = let commit = "14a4c47758ea02c40c3ef46b00931ffdfaab0a40"; in buildUpstreamOpenRAEngine {
    version = "25876.git.14a4c47";
    rev = commit;
    sha256 = "12db2xbjp73shm0pqfy5iw890vd7gxy3yxwrlimmwnm54hbcaknw";
  };
}
