...
in {
  ...
  bleed = let commit = "ac7d2e00e3a7fe319339a8ada814209e4f7ffa87"; in buildUpstreamOpenRAEngine {
    version = "25817.git.ac7d2e0";
    rev = commit;
    sha256 = "0b993vqkkzbi714krizngw9hjryqyq1ccvqn48qv21xrkghp2qsr";
  };
}
