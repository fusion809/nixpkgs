...
in {
  ...
  bleed = let commit = "9f419fca3424eae703f6ff7dc801ab6604fff573"; in buildUpstreamOpenRAEngine {
    version = "25803.git.9f419fc";
    rev = commit;
    sha256 = "08b6xnlm9c3vzayqc6290pjxjhr34m47sbh9my1201wkjg4z6ghf";
  };
}
