...
in {
  ...
  bleed = let commit = "30e2b69dba734bfa043dc64b8d3fece64dc78574"; in buildUpstreamOpenRAEngine {
    version = "26246.git.30e2b69";
    rev = commit;
    sha256 = "1405v5sn7fxr2avhkhfhg1izd1c4a0fb3y2b6iasn4i9a80rg7qd";
  };
}
