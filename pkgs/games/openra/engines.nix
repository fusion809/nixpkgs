...
in {
  ...
  bleed = let commit = "16f17502528f5a53d38a8572eddff314e25c37ad"; in buildUpstreamOpenRAEngine {
    version = "25821.git.16f1750";
    rev = commit;
    sha256 = "0nrpi1426sa0na7k7w0glszqssnn9sr9jg4qynvr1fl8q46hp5a1";
  };
}
