...
in {
  ...
  bleed = let commit = "ddc4c4ff0609b71204f4f8d990f5424344143a2a"; in buildUpstreamOpenRAEngine {
    version = "26305.git.ddc4c4f";
    rev = commit;
    sha256 = "0rbbsygrfq2r2rd3wh30glp8ririy9npmpahcv70xkszcj0g2hk3";
  };
}
