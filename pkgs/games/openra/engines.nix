...
in {
  ...
  bleed = let commit = "4193247169e04e60fdd947c80bd1aee20b9032bc"; in buildUpstreamOpenRAEngine {
    version = "26324.git.4193247";
    rev = commit;
    sha256 = "1kvhgfv2mxvzwfij19gr99528p6iif2xvdq5iv2d7df9hw1ql97n";
  };
}
