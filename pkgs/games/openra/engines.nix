...
in {
  ...
  bleed = let commit = "1543ccb749a0edc80b36254f9709d3bb128613ee"; in buildUpstreamOpenRAEngine {
    version = "26304.git.1543ccb";
    rev = commit;
    sha256 = "0cwf8nw248y36kklg9bygrn0yhsla852j62i8cyyx7xkj1j16idh";
  };
}
