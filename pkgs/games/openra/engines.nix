...
in {
  ...
  bleed = let commit = "7695714f6673b074e40ad85618da078c0ced35e7"; in buildUpstreamOpenRAEngine {
    version = "25839.git.7695714";
    rev = commit;
    sha256 = "1012vl0xjiw0n0ika5id5ydq785npamx5z0bmxinjrzcnwvfpar4";
  };
}
