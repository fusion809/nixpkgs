...
in {
  ...
  bleed = let commit = "77b313611eaa8a07f54a8debeed998be4e12928a"; in buildUpstreamOpenRAEngine {
    version = "25915.git.77b3136";
    rev = commit;
    sha256 = "0swq44gk7s467wg295ab8vyf3ypjl2jlr53yp7jz26hl2l34v0zv";
  };
}
