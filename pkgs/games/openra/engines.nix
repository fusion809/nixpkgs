...
in {
  ...
  bleed = let commit = "4f6aa79e9150dcde6e8bdd872339e2877c8188a3"; in buildUpstreamOpenRAEngine {
    version = "26209.git.4f6aa79";
    rev = commit;
    sha256 = "0ymljfra7dyr32q2q2gwnjdb4jz86rmd6s8ppw24608x0n479px2";
  };
}
