...
in {
  ...
  bleed = let commit = "7fe2d1223ba13125f072f05d492625f82db67818"; in buildUpstreamOpenRAEngine {
    version = "25851.git.7fe2d12";
    rev = commit;
    sha256 = "0inh8lbi2hb6v4qp9m06ymcphnk0bz1hr73bz8kh56p72z41im17";
  };
}
