...
in {
  ...
  bleed = let commit = "560f8c26bca3c2bdfa9b1280c8f3626dba7625af"; in buildUpstreamOpenRAEngine {
    version = "25906.git.560f8c2";
    rev = commit;
    sha256 = "00j20fdj0k6b5gswhgal59ddij3fpaf2yhgp9l1jhbchk6lzn7rm";
  };
}
