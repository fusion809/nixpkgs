...
in {
  ...
  bleed = let commit = "0bb832917af6bd37971f39cc9f49f81440edf112"; in buildUpstreamOpenRAEngine {
    version = "26035.git.0bb8329";
    rev = commit;
    sha256 = "0bvpkp2ydwlgbmdi51fmppg74rsh4csiyvbfsnvfms4i28p3c6b7";
  };
}
