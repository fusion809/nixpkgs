...
in {
  ...
  bleed = let commit = "c00b13a18ee8bbd70832db73ce036599ccad16e2"; in buildUpstreamOpenRAEngine {
    version = "26280.git.c00b13a";
    rev = commit;
    sha256 = "1lpv1nfqjgr55wwgji9xymk17ahlxy8ch7w5xhwff6vd5a5k860k";
  };
}
