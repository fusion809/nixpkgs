...
in {
  ...
  bleed = let commit = "b59ae476e40fbb8072cfda54c6b6f2c758694f52"; in buildUpstreamOpenRAEngine {
    version = "26150.git.b59ae47";
    rev = commit;
    sha256 = "1xab7f6wxvgarrr7rnmb597kg1scpk6rb489jch5mbnxld0bni86";
  };
}
