...
in {
  ...
  bleed = let commit = "9fc8b829e4c2bb0362eef68405df603b88865ee3"; in buildUpstreamOpenRAEngine {
    version = "26061.git.9fc8b82";
    rev = commit;
    sha256 = "1xlagkg29dxinfxm2b8xyqw4m9lj6vr905mrpkmb5lq0qrhs8xdc";
  };
}
