...
in {
  ...
  bleed = let commit = "ea2e452075fb2436385711272b4c7eba55595043"; in buildUpstreamOpenRAEngine {
    version = "25787.git.ea2e452";
    rev = commit;
    sha256 = "1x4lw8hyl02dibls0skczdvns2ykrrqhpgpji6fpkrqkfwpx0xcc";
  };
}
