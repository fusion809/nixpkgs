...
in {
  ...
  bleed = let commit = "9ac3d7507c8c032ecb8ea986997d66b97528075b"; in buildUpstreamOpenRAEngine {
    version = "26274.git.9ac3d75";
    rev = commit;
    sha256 = "1mv1j2h8v365lb01fa796gwqryx5ifh6px3wa9mis93zhnrpgsml";
  };
}
