...
in {
  ...
  bleed = let commit = "cc7e758b27aefa573094ca7d3551ae46022264a3"; in buildUpstreamOpenRAEngine {
    version = "25885.git.cc7e758";
    rev = commit;
    sha256 = "013zcal6bz30cg88npy0nhk48qdwnrik5abgxvm6k24nzqd3w1z2";
  };
}
