...
in {
  ...
  bleed = let commit = "a4b8ffa99dab0679464e3abbf3e4564fa8601070"; in buildUpstreamOpenRAEngine {
    version = "26293.git.a4b8ffa";
    rev = commit;
    sha256 = "12iai2srbpyp4d7hqwqisbx7cr1x4picd2m0ifkp23zjnf58697y";
  };
}
