...
in {
  ...
  bleed = let commit = "f325a4d190f74e1519935fcf2111474c1cf045ce"; in buildUpstreamOpenRAEngine {
    version = "26187.git.f325a4d";
    rev = commit;
    sha256 = "16ksfg9cyl548zjp434fzz09vbxqwb57l2hx067pa675dxjcv97p";
  };
}
