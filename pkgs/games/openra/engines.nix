...
in {
  ...
  bleed = let commit = "1614cba99eb30a3f227292b92f7d84f1e4dcb243"; in buildUpstreamOpenRAEngine {
    version = "26098.git.1614cba";
    rev = commit;
    sha256 = "1dvzhcc5j0fncx41zq8jr5mnvl8zvh48vswy7fanpm6f0ypaiiz8";
  };
}
