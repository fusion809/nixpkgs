...
in {
  ...
  bleed = let commit = "8edbf665c5f06a06123eb4f4e2f447c8356efbb7"; in buildUpstreamOpenRAEngine {
    version = "25807.git.8edbf66";
    rev = commit;
    sha256 = "0w0rrfm8a50g9y28kdf1y5wjxkc18dws9dl0gsr9ibljpy9g0p1s";
  };
}
