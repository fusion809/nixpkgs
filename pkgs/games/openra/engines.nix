...
in {
  ...
  bleed = let commit = "dc9c758f1224849b41b6e5fdff8e77934b447d64"; in buildUpstreamOpenRAEngine {
    version = "25716.git.dc9c758";
    rev = commit;
    sha256 = "0yxr6bvnhzib8cy3q90jgrzfyssjygcgvp5sk2g89mhb59k9q4zy";
  };
}
