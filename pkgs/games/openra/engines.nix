...
in {
  ...
  bleed = let commit = "c096fbde962a7e36aaaf77e1a0889fa3d90dff29"; in buildUpstreamOpenRAEngine {
    version = "25795.git.c096fbd";
    rev = commit;
    sha256 = "1kkhd5p3av0fa39xyxj15kzhcy4l9zp28gsbw8a6dk83p14pqqrs";
  };
}
