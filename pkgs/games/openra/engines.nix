...
in {
  ...
  bleed = let commit = "9f59b007ab0fc7945320ef4972cc085b9771bb60"; in buildUpstreamOpenRAEngine {
    version = "26155.git.9f59b00";
    rev = commit;
    sha256 = "1k0sabchl10m8m6c1pza5dyj68a7g81sw1y7wh5bkqak57ycjyls";
  };
}
