...
in {
  ...
  bleed = let commit = "77d890848b7909ea719d8f7ec7239432047c222e"; in buildUpstreamOpenRAEngine {
    version = "25958.git.77d8908";
    rev = commit;
    sha256 = "0r3b3pvmhx41crz3yblbaq1jmyk4ax6xp5vafckngb2ikpcic3mv";
  };
}
