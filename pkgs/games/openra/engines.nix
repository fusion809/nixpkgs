...
in {
  ...
  bleed = let commit = "6dd84b2882ad47c0efd61991b5104f3ce52fc8af"; in buildUpstreamOpenRAEngine {
    version = "25783.git.6dd84b2";
    rev = commit;
    sha256 = "0yzv9lyp5rpdqnwx2wc7kky74ysb7a0h8favb1kxx0bshczamsi3";
  };
}
