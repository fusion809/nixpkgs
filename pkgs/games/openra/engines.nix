...
in {
  ...
  bleed = let commit = "71995dbcbeb4b177a285a61b7dd821056f97bb7c"; in buildUpstreamOpenRAEngine {
    version = "26068.git.71995db";
    rev = commit;
    sha256 = "0hvkadar120n2aailgalwwnh8vrndw9mh9vkki56cbhhlxpyax00";
  };
}
