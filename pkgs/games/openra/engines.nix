...
in {
  ...
  bleed = let commit = "320717003fd3c4fe8151ae3229684f97825c7789"; in buildUpstreamOpenRAEngine {
    version = "25860.git.3207170";
    rev = commit;
    sha256 = "1a35s3ddamfrkxk9l1wrr4sn425nwphifxknpnjkn3jhk7ybs5ph";
  };
}
