...
in {
  ...
  bleed = let commit = "ab94ea9715393e2ed5436cba8e0fbf163f33ea28"; in buildUpstreamOpenRAEngine {
    version = "26361.git.ab94ea9";
    rev = commit;
    sha256 = "1h5gm5hjbkvp5i6yx5vp8krcjrpi2bb1nlgc8qvcbrsgzxw9cfh4";
  };
}
