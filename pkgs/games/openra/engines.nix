...
in {
  ...
  bleed = let commit = "7544d4b4e6efe5183dc43caa59b13e621d173072"; in buildUpstreamOpenRAEngine {
    version = "26356.git.7544d4b";
    rev = commit;
    sha256 = "1mfb6dkgnwkpkxy95k80kxwbnh625g88jwjv0dvmqyb0bq2h42al";
  };
}
