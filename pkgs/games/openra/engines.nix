...
in {
  ...
  bleed = let commit = "3a30b013a5e5cab256f1e57b3f4d236010e0bc2e"; in buildUpstreamOpenRAEngine {
    version = "26094.git.3a30b01";
    rev = commit;
    sha256 = "0y49fsh7qizyjy61mw006sg2fsap993jf8hhnjh4ndgvskig8li7";
  };
}
