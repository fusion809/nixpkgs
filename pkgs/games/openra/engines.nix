...
in {
  ...
  bleed = let commit = "f46cad5347c7ebac2f129903dd970561c9a71b8c"; in buildUpstreamOpenRAEngine {
    version = "26267.git.f46cad5";
    rev = commit;
    sha256 = "13cwrrk6ws029g9vh0a794z76hl4lm0hv31mc0rw43cw3a0xlng2";
  };
}
