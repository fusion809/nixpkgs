...
in {
  ...
  bleed = let commit = "1d3754f9c0908606564a82ebff47d2a77f43470a"; in buildUpstreamOpenRAEngine {
    version = "26133.git.1d3754f";
    rev = commit;
    sha256 = "064g832476bdm5ngblj48xf84j6h8d2wswyq9jqz1k6k1br7fhgl";
  };
}
