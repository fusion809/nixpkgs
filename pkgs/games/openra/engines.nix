...
in {
  ...
  bleed = let commit = "a7617b2443465417ef418dc89d4736e4a2f58abc"; in buildUpstreamOpenRAEngine {
    version = "26137.git.a7617b2";
    rev = commit;
    sha256 = "0q785qmk977wglgdjsb4yv7srpw6kzh86k38plj2h2npplb10srn";
  };
}
