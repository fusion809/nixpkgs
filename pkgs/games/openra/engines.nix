...
in {
  ...
  bleed = let commit = "1c13520ffdf8196e9ba5868ee0b9d7be8ffa58a5"; in buildUpstreamOpenRAEngine {
    version = "26003.git.1c13520";
    rev = commit;
    sha256 = "18ixcbcgdcymwrvzg4myhz2763r5iqz6xi4hbpgfx56jxlgjrq0n";
  };
}
