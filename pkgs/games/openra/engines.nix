...
in {
  ...
  bleed = let commit = "25bc3ae2d24265b18c4eaa7697ef3bb5cf7f1b1c"; in buildUpstreamOpenRAEngine {
    version = "25863.git.25bc3ae";
    rev = commit;
    sha256 = "012g4w4ckxgqvvjrbrm2g6xan8qwsxyyrwzvbphhmc2kdcxi0pln";
  };
}
