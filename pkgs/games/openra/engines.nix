...
in {
  ...
  bleed = let commit = "58bb7fcbc03c96f70b3d15bfae1ce697acc7a101"; in buildUpstreamOpenRAEngine {
    version = "26300.git.58bb7fc";
    rev = commit;
    sha256 = "1ajf67m2imvwr6p8b21bxxan38rs2bk6ivpa9fdvr9j6vdh55pfv";
  };
}
