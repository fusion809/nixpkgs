...
in {
  ...
  bleed = let commit = "8ffd8ae822e404683927a348b6620970af6b499d"; in buildUpstreamOpenRAEngine {
    version = "26302.git.8ffd8ae";
    rev = commit;
    sha256 = "0rz1gpwnbf1byn2k6yzk209dkfjw8gzp69qrfxqpiapj6ca33ddb";
  };
}
