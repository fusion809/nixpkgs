...
in {
  ...
  bleed = let commit = "207305e7d21d37b71b385b09e10752ed43235cb4"; in buildUpstreamOpenRAEngine {
    version = "26295.git.207305e";
    rev = commit;
    sha256 = "1xigfl9rcwf5b7iivq0cfhh4jw660wnw88g9nb4hx47l9gkykxzg";
  };
}
