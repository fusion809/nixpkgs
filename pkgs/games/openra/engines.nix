...
in {
  ...
  bleed = let commit = "c8a42cbce2c580438bf5a5f54e3ffc8a5d5a8cfa"; in buildUpstreamOpenRAEngine {
    version = "26151.git.c8a42cb";
    rev = commit;
    sha256 = "1ykwpiqfrrpcqkkpzi74y5xbs3dd9w2wb98bq9cv1fk5j8kp3ari";
  };
}
