...
in {
  ...
  bleed = let commit = "824db72a4cfbd8c6f82bbe60b4bea5c6da327f56"; in buildUpstreamOpenRAEngine {
    version = "26218.git.824db72";
    rev = commit;
    sha256 = "19d368pb030b2438af1scaii4bbvakq27l909vqjfmmz83rjwna8";
  };
}
