...
in {
  ...
  bleed = let commit = "336cfedf84060cd2f70889564795da4e6894a8a0"; in buildUpstreamOpenRAEngine {
    version = "26036.git.336cfed";
    rev = commit;
    sha256 = "0x4d51p4ml144q91s62xhdd4662khd4jdr26vqnrg7yd0bczabsn";
  };
}
