...
in {
  ...
  bleed = let commit = "f26992443d557266a67d565113b88e35e7486210"; in buildUpstreamOpenRAEngine {
    version = "25951.git.f269924";
    rev = commit;
    sha256 = "0dg84xn283421j8jz3284kflzdf3i81w9k52hga249b3lii40z4b";
  };
}
