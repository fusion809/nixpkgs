...
in {
  ...
  bleed = let commit = "d5f42c062896fd73e243e8737f791e0a018c118f"; in buildUpstreamOpenRAEngine {
    version = "26370.git.d5f42c0";
    rev = commit;
    sha256 = "01ndyscyxbnaz5w5cx2qm52z0d1p87m50pnr7z7kkkdk3xzk166q";
  };
}
