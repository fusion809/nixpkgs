...
in {
  ...
  bleed = let commit = "8fa7bb16f8970b542a5f497f7bb8b08ba3eb18fa"; in buildUpstreamOpenRAEngine {
    version = "26251.git.8fa7bb1";
    rev = commit;
    sha256 = "0kva9hsiikk4h7qb3yhmdgy1rilqsbhys6fzh2igxhj7rh2r6qkn";
  };
}
