...
in {
  ...
  bleed = let commit = "71dd84b9d56dbeb564c2ec072d160e0301718777"; in buildUpstreamOpenRAEngine {
    version = "25779.git.71dd84b";
    rev = commit;
    sha256 = "1ikjrppqblkq2yrqg2wjml76m89f55fnqniafimg8vr5yhxzq64c";
  };
}
