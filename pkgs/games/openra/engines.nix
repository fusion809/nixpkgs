...
in {
  ...
  bleed = let commit = "8ae2b004146cbde0f5b627c88830141ac1fd242f"; in buildUpstreamOpenRAEngine {
    version = "26290.git.8ae2b00";
    rev = commit;
    sha256 = "1y8hr6hsvxsmhdmyb8s59f552vp5g0mzbxhqbk7cszcshpbilfl6";
  };
}
