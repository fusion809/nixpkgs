...
in {
  ...
  bleed = let commit = "017eca3dc183ea0d365606c88e73b662fec91135"; in buildUpstreamOpenRAEngine {
    version = "26310.git.017eca3";
    rev = commit;
    sha256 = "1ad3l7yfdmyh8x8akap9hkfq61m6scvsy1ds5m0c2did31iphavg";
  };
}
