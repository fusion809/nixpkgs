...
in {
  ...
  bleed = let commit = "5ec47b47af77ad0a7806025fd3c62a08a22ec458"; in buildUpstreamOpenRAEngine {
    version = "25784.git.5ec47b4";
    rev = commit;
    sha256 = "1xxwa00mwpy0ib3adqca82g8n748hby207k1biwqx9whjnh9v6ml";
  };
}
