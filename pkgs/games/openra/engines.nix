...
in {
  ...
  bleed = let commit = "a38c2d9aaef1a2e0a068dd73818f5f162f9a3686"; in buildUpstreamOpenRAEngine {
    version = "26259.git.a38c2d9";
    rev = commit;
    sha256 = "1lpn0rypp7dh6arxnmn6ak52125fwqjbvq540qk49sfw3lzg8lhk";
  };
}
