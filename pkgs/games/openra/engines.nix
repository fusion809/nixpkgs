...
in {
  ...
  bleed = let commit = "3e39ada304717a9c981cfce101e8ebbc6d4668f5"; in buildUpstreamOpenRAEngine {
    version = "26194.git.3e39ada";
    rev = commit;
    sha256 = "1qpyy1vhpmhjjqyxdpmxiy6n3pww9if3q0d2h1ml6prradnxzl0q";
  };
}
