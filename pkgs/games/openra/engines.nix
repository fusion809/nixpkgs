...
in {
  ...
  bleed = let commit = "8f7da18dc5fed8865be0577e6260ae4e9726793c"; in buildUpstreamOpenRAEngine {
    version = "26347.git.8f7da18";
    rev = commit;
    sha256 = "0ahbprkh70gbnpms35pm4mympwxnydc7xpm673lhxwqviby2i3dq";
  };
}
