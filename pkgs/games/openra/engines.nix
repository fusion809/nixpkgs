...
in {
  ...
  bleed = let commit = "556774804f4597c46ef8c19254273e1fa46cfea3"; in buildUpstreamOpenRAEngine {
    version = "25801.git.5567748";
    rev = commit;
    sha256 = "17rbiz90dsgcqj81701j3r3gjwj4pirzihpp3bnvi02gkdwwl98j";
  };
}
