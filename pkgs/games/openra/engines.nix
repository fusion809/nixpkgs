...
in {
  ...
  bleed = let commit = "2f99512bd41fbe0446a791774e76c57508e36d61"; in buildUpstreamOpenRAEngine {
    version = "26292.git.2f99512";
    rev = commit;
    sha256 = "1xp5ai7h7ail3cmg5agchvn6w93sxrw0bi3mwqhz45c2d8680vnf";
  };
}
