...
in {
  ...
  bleed = let commit = "2a6f2bbe0eaf560f515880da152ff1a003cb633a"; in buildUpstreamOpenRAEngine {
    version = "26349.git.2a6f2bb";
    rev = commit;
    sha256 = "0q6zwk5b2iih84hsakk8vzjzz0gnr25cr50423hmylk2va6b6p8a";
  };
}
