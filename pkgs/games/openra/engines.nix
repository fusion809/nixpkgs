...
in {
  ...
  bleed = let commit = "ff1d4ec9aeff1a729670502fa9acefd34ed6f8c5"; in buildUpstreamOpenRAEngine {
    version = "26333.git.ff1d4ec";
    rev = commit;
    sha256 = "188zsh62y4zl97akrczazjfl4vy5idczllgsl9sm18sglmbl2a01";
  };
}
