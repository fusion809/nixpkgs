...
in {
  ...
  bleed = let commit = "0b0b82bd43beb05021abd7a1a2c6001c94003345"; in buildUpstreamOpenRAEngine {
    version = "25768.git.0b0b82b";
    rev = commit;
    sha256 = "1r9ywdai83s4cfyg6cdly6vixwrln0ivzqfqyja5bss49wjpqbhc";
  };
}
