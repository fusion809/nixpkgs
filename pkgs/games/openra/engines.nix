...
in {
  ...
  bleed = let commit = "3bc5b072779ba31026aa1080d044547006f63b29"; in buildUpstreamOpenRAEngine {
    version = "26013.git.3bc5b07";
    rev = commit;
    sha256 = "10ahwspq7a3sydbhw7l55mc6v2i1wyczkchjizm6vswch97zlfd7";
  };
}
