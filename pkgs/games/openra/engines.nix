...
in {
  ...
  bleed = let commit = "ebe37a44adcda4e90a0cb4409c05874f3abcc762"; in buildUpstreamOpenRAEngine {
    version = "26125.git.ebe37a4";
    rev = commit;
    sha256 = "17rwirchmq8h115gcf7nlzp5nbjppc0ya29aazyf7dajxbjskmp0";
  };
}
