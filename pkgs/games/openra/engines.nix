...
in {
  ...
  bleed = let commit = "01f6f9809725187f8f3edfb1a2ead54003c10f96"; in buildUpstreamOpenRAEngine {
    version = "25818.git.01f6f98";
    rev = commit;
    sha256 = "0q0m3ac8phys0cvqw2ghyja72kp99q7hjkqdgx2hl290hq1qx7wk";
  };
}
