...
in {
  ...
  bleed = let commit = "e6750bf19cee87433ed977312fed5133336d7ca1"; in buildUpstreamOpenRAEngine {
    version = "25891.git.e6750bf";
    rev = commit;
    sha256 = "0n5vbhl42isv7d61z2al5azrhkcpdf0bca416v7dj1dn54kl3ajs";
  };
}
