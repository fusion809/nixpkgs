...
in {
  ...
  bleed = let commit = "db0c6d88bf9ae6e291850d5b8a12697c06d95cd3"; in buildUpstreamOpenRAEngine {
    version = "26156.git.db0c6d8";
    rev = commit;
    sha256 = "05ck66z47i9r5b6y9kirb7y78cywprd7kz5rgx927bxmflmfq5lb";
  };
}
