...
in {
  ...
  bleed = let commit = "ab4268025af372b6f13f2cb79502eac2dbccaca9"; in buildUpstreamOpenRAEngine {
    version = "25786.git.ab42680";
    rev = commit;
    sha256 = "1ciq4cbi7b9xgmrz317qd409lkd8d0jcs64s8zapg8ykfrqi3jp0";
  };
}
