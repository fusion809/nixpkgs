...
in {
  ...
  bleed = let commit = "817db8dbe034dc510fbf29508c53409e1dae0241"; in buildUpstreamOpenRAEngine {
    version = "25825.git.817db8d";
    rev = commit;
    sha256 = "13l4bbj1dwds49mzs17pvi45r0d4mgnfm89042wfbml0vgd1xpah";
  };
}
