...
in {
  ...
  bleed = let commit = "54d5afed573ad7d6bc7a50b5c4ad26145154bf53"; in buildUpstreamOpenRAEngine {
    version = "25836.git.54d5afe";
    rev = commit;
    sha256 = "175l986mb0jyajbnhrvqgkwcggj4fhkvki0x49h10plj6nl8zxjd";
  };
}
