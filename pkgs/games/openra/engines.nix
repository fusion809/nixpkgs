...
in {
  ...
  bleed = let commit = "a491bae39bc9bc1d9dc38ee6cd60cccba210e05f"; in buildUpstreamOpenRAEngine {
    version = "26363.git.a491bae";
    rev = commit;
    sha256 = "02dmc01jaqz044g2vyffvxfjx42vmignh4f9i2zgxlbvgf508d9g";
  };
}
