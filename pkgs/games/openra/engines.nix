...
in {
  ...
  bleed = let commit = "ff9db0bf7a067166edbf7039b05105d7649b9653"; in buildUpstreamOpenRAEngine {
    version = "26200.git.ff9db0b";
    rev = commit;
    sha256 = "19vf1wakxnc2fz345r73608mw7ckw1b1bsfr50swcqb0cv5kih9n";
  };
}
