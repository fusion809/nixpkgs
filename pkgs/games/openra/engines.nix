...
in {
  ...
  bleed = let commit = "e2a51676f7a4a733533f8b058a99a0525f3725eb"; in buildUpstreamOpenRAEngine {
    version = "25810.git.e2a5167";
    rev = commit;
    sha256 = "102kbgqsycs2bkzgla3mc5wxfyqki1f6zm8prik9i1s517dqiz8r";
  };
}
