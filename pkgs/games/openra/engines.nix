...
in {
  ...
  bleed = let commit = "19977bb7da220801e97b69bb9f6ba4e40b10a45b"; in buildUpstreamOpenRAEngine {
    version = "25840.git.19977bb";
    rev = commit;
    sha256 = "1adhi5jv50hdkzzmkwylzh1bz9nqpcif87wngm3qgwkwvjam8ahx";
  };
}
