...
in {
  ...
  bleed = let commit = "3fe78a831126c8187e284350bae455936aeb1dc9"; in buildUpstreamOpenRAEngine {
    version = "26353.git.3fe78a8";
    rev = commit;
    sha256 = "1s2xsnsa7xf4f3dxpcbcs26bzjsak9956wfiiqjgwxki6m1xbxhm";
  };
}
