...
in {
  ...
  bleed = let commit = "e2b27328bd761fc9335182bcfb31dde84c22ee87"; in buildUpstreamOpenRAEngine {
    version = "26085.git.e2b2732";
    rev = commit;
    sha256 = "1mrmp31sm38yn5rbnr9p1mbj4npx5i4vp8f1g13xypq0yz36rf2i";
  };
}
