...
in {
  ...
  bleed = let commit = "ffac21c3d326b25ab71a2332ebc2cd64ff890352"; in buildUpstreamOpenRAEngine {
    version = "25760.git.ffac21c";
    rev = commit;
    sha256 = "14lniaj4vhwswxh9wb4fcbrqaqya953z91w0k5w8sq5iywfw51v9";
  };
}
