...
in {
  ...
  bleed = let commit = "1c03fb9e516e0690a2008749d754ad453e0dd733"; in buildUpstreamOpenRAEngine {
    version = "26225.git.1c03fb9";
    rev = commit;
    sha256 = "17sf0n74ckqxrc7mj4lisrmpsz0ljg1cq40bj13w7l5m7ymamj87";
  };
}
