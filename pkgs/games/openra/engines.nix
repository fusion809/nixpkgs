...
in {
  ...
  bleed = let commit = "cc84daacea32f378bf13f5ca2b3f24f3869419d8"; in buildUpstreamOpenRAEngine {
    version = "26285.git.cc84daa";
    rev = commit;
    sha256 = "1qn4yzrsg1mj84bxdfyxhpg4jjpznbwnn7hwrlxlxmlm9wnqdlri";
  };
}
