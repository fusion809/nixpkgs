...
in {
  ...
  bleed = let commit = "98125a3d947adbfb7af2946d4bdba2261e4db4ca"; in buildUpstreamOpenRAEngine {
    version = "26179.git.98125a3";
    rev = commit;
    sha256 = "0jl18kjpwibwlxwh6zl363cwwi9xjc5xdqkhn1idlw8gzg988q5v";
  };
}
