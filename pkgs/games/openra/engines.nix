...
in {
  ...
  bleed = let commit = "d26919efd5821fcb8976b58a2c9babbd6b8f314f"; in buildUpstreamOpenRAEngine {
    version = "26175.git.d26919e";
    rev = commit;
    sha256 = "0yfxc16ryxy8hyv5lhk5ivigmvwxgn17p1s00ivnh3zmrda3wycd";
  };
}
