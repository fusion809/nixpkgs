...
in {
  ...
  bleed = let commit = "ef47a3394f2792f3b3f01a15ca165fd3d359f279"; in buildUpstreamOpenRAEngine {
    version = "26049.git.ef47a33";
    rev = commit;
    sha256 = "0ddyvq4578yrp3mp7jxdyxvx1fxjhh2yh8mrwmrv6mh9inkn8l2j";
  };
}
