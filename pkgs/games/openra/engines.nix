...
in {
  ...
  bleed = let commit = "f25449a3bfc200b7005d3e638ad084882d19f7ea"; in buildUpstreamOpenRAEngine {
    version = "26273.git.f25449a";
    rev = commit;
    sha256 = "1f8z0prjr7c8bb0m9piaqph4kny3b7qfn30digzzx7hpb2y4xvsb";
  };
}
