...
in {
  ...
  bleed = let commit = "982291119cb5cb54cf8932039db9b2f56e728bab"; in buildUpstreamOpenRAEngine {
    version = "26099.git.9822911";
    rev = commit;
    sha256 = "16isbyhnlg19qikd79b31avg5fch5xc1527mbz9r1fbg17wzdkn6";
  };
}
