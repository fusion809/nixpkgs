...
in {
  ...
  bleed = let commit = "29d238ba03dd8c192d9c0f0b28d9b4069212e633"; in buildUpstreamOpenRAEngine {
    version = "26067.git.29d238b";
    rev = commit;
    sha256 = "16sq7mvp0c4kql3j1q8d0cy7al15nxg4bzqvh5ywg30b1n5mjcal";
  };
}
