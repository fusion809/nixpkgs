...
in {
  ...
  bleed = let commit = "da0b24e8912cba31e0663b5e0d7e506941e4f5e4"; in buildUpstreamOpenRAEngine {
    version = "26207.git.da0b24e";
    rev = commit;
    sha256 = "1kazkys6xf6i642vj01pf74vylxz0zf5ip8x7hzsscdrgl113d24";
  };
}
