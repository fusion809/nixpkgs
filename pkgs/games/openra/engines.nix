...
in {
  ...
  bleed = let commit = "8f573568c88d0f00e116cf8aa4d97c6546e4cbdf"; in buildUpstreamOpenRAEngine {
    version = "26180.git.8f57356";
    rev = commit;
    sha256 = "0a2irqx9bbwsw5xqkqj15jwsj3gcfcwacjiijv6bjizmbgkjjh9k";
  };
}
