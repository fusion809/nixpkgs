...
in {
  ...
  bleed = let commit = "1373a4e16e77ddf8188460080f54bc674c752b7b"; in buildUpstreamOpenRAEngine {
    version = "25859.git.1373a4e";
    rev = commit;
    sha256 = "0vg8zc0pgiq9xc34f1g2wb3dm9hyzqhqrbyfpqc0pjzmlvbz2aca";
  };
}
