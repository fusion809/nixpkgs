...
in {
  ...
  bleed = let commit = "a2775a5c0f30490da4881a73f0c261189ee828d7"; in buildUpstreamOpenRAEngine {
    version = "26043.git.a2775a5";
    rev = commit;
    sha256 = "0rzrg13fskb9rsdrfbzr34y7xjq2i4ziarlqp6p2gm0x357jhp2s";
  };
}
