...
in {
  ...
  bleed = let commit = "a260b50ce1aeef50c56ef3efd92df3b0cb34c016"; in buildUpstreamOpenRAEngine {
    version = "26164.git.a260b50";
    rev = commit;
    sha256 = "0pzpz6jgxx9bcwq687s9fhlx2jkprl08z8nqr2ski40b0pdm52k8";
  };
}
