...
in {
  ...
  bleed = let commit = "7f3c527f4e333723622b78b877f49bf4d5814171"; in buildUpstreamOpenRAEngine {
    version = "25730.git.7f3c527";
    rev = commit;
    sha256 = "1mllbg4skp4bi6ccrywbvy6im97baaj16d9yyklprqr033slidjj";
  };
}
