...
in {
  ...
  bleed = let commit = "00b8576edf7e992be19b459e4a9480d9b874b4b2"; in buildUpstreamOpenRAEngine {
    version = "25799.git.00b8576";
    rev = commit;
    sha256 = "0yga1zz2k6jd8dwxj5xyyfnmd2mcqm3ylfy1bc2gvagm6xhrp5r0";
  };
}
