...
in {
  ...
  bleed = let commit = "4bf659ca38dbc8de3dc3cc0264ec9c72984ad4f8"; in buildUpstreamOpenRAEngine {
    version = "26250.git.4bf659c";
    rev = commit;
    sha256 = "0gf9p7jpgjr754da22n77ifpzxjw1ab8y0laa6v768l4k9mymvx7";
  };
}
