...
in {
  ...
  bleed = let commit = "8edd202b64a935ee8ccb22c2f8192fe2431d6029"; in buildUpstreamOpenRAEngine {
    version = "26381.git.8edd202";
    rev = commit;
    sha256 = "14jyx457ild5wgwk3931mnmwpsyq17c2ii2nalh34jp2assidjwy";
  };
}
