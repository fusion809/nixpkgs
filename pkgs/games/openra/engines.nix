...
in {
  ...
  bleed = let commit = "c0d5cd750df682c4765971c456bdf2d5dc83b216"; in buildUpstreamOpenRAEngine {
    version = "26312.git.c0d5cd7";
    rev = commit;
    sha256 = "1sd4jk3988qqpb4l1apy9059bswajiwkzrk3wx441ispyq75smls";
  };
}
