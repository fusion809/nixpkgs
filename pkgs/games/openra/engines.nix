...
in {
  ...
  bleed = let commit = "6f1aaab3e335d21cb90951ab3035b05fbcae8feb"; in buildUpstreamOpenRAEngine {
    version = "26009.git.6f1aaab";
    rev = commit;
    sha256 = "1fik72sswf04n7wvp3jczb5v1zgya4l3jhin09rdvy5p6syb578q";
  };
}
