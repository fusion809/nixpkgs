...
in {
  ...
  bleed = let commit = "8b0f2e14623a95f8d3231d7234773aa77cf04e45"; in buildUpstreamOpenRAEngine {
    version = "26371.git.8b0f2e1";
    rev = commit;
    sha256 = "0xb0nhzvy8d58wwr6qy7lif2xvpscvypna8caildcqs193ij8xw8";
  };
}
