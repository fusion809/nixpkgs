...
in {
  ...
  bleed = let commit = "37325dbfc7724f40bf3c39a391c67bf204b61511"; in buildUpstreamOpenRAEngine {
    version = "26230.git.37325db";
    rev = commit;
    sha256 = "0b35w43afdg73pys31dvfda9afigfwx925b69rhzp6lk6c3ch6h8";
  };
}
