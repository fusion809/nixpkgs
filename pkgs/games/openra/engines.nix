...
in {
  ...
  bleed = let commit = "b774556a5f41310393915fa036a5b6731f9a689c"; in buildUpstreamOpenRAEngine {
    version = "25972.git.b774556";
    rev = commit;
    sha256 = "1kdrd34s0c8h68mcpxp8l3v57a1qzpn2zlw3dlr93hmmmbhi4ya6";
  };
}
