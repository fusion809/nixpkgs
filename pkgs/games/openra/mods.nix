...
in {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3372358e0b8b3ab7d89b68ab0ee64c6f141a7ac6";
      sha256 = "1pdl7rxi6nlq3ffv1gz6afkx5gf067jkbjlkdhidrrzby04r2zvr";
    };
  ...
  yr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "cookgreen";
      repo = "yr";
      rev = "ae0c8a387fb944bdca3c7c01f937e9c95ac022da";
      sha256 = "1c8qaplshwf40hjnwlnq1rfh9g8rbrsk5zfjkc38prqlvf6prml2";
    };
    engine = rec {
      version = "98fd0dd";
      src = fetchFromGitHub {
