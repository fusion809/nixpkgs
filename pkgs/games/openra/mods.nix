...
in {
  ...
  d2 = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "d2";
      rev = "f21b3169f1bc6f766f127a30030b6369a5226bc5";
      sha256 = "1q0fr20a8ibnyxks2whnfw5f9xvmwkxs9zlbqdhkjvf7d1sg10l2";
    };
    engine = rec {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "edf045d3e0a665bbdf3bea79c4482724b6fb7053";
      sha256 = "03f9dj152fyxi06zdnvwhfhr12z2kh71prgr8vnlsh74hsv29gqy";
    };
