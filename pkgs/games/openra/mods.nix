...
in {
  ...
  dr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "drogoganor";
      repo = "DarkReign";
      rev = "9582173cc0fc8775d4eec83a0b3c243a6eb66e76";
      sha256 = "0vsjhn5z93k1hsvhr547w992ibrvnahq3vwn1kqpfmqwmay2g3h8";
    };
  ...
  gen = buildOpenRAMod {
    ...
    src = fetchFromGitHub {
      owner = "MustaphaTR";
      repo = "Generals-Alpha";
      rev = "62bbd89d0a1f0e5e9ba300f1cbded90f793d9421";
      sha256 = "1spc62izm0znmi0q18bmf842j7y32akk10cc47125qxhfd5fvbrs";
    };
    engine = rec {
      version = "gen-20190128";
      src = fetchFromGitHub {
        owner = "MustaphaTR";
        repo = "OpenRA" ;
        rev = version;
        sha256 = "0hjyg7xyf6rw2rnylxbl9742g9c7fqwnyfqzj87vsrmr8rhawl0d";
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5367e8f86a756b3176e6c3dbe1ca5ec8b62b4060";
      sha256 = "1hdpja4kdpm565lm766ql7np0nnpm1fvrlqfypbh4s11q7y70lbh";
    };
