...
in {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "357c2a7f1ba3ec08cf8bdb36312a11bda72cc9a6";
      sha256 = "0xralyfvgqbqa4kvnlggryhv8klv8k4663g3ry66z23im6ynigfh";
    };
  ...
  ss = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "MustaphaTR";
      repo = "sole-survivor";
      rev = "298e2a0103beae52b710836130b70efc80c47f3d";
      sha256 = "1446kwhznbylgimqigql3jjzjwdq566v1k0hb0dyl2bfkd5s7z4r";
    };
    engine = let commit = "2f6e50a"; in {
      version = abbrevCommit commit;
      src = fetchFromGitHub {
        owner = "OpenRA";
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "059glnsx96xhwvv7ikj33g83xc9cm3m5mbx2dkqw7z04h3y5i8w9";
        name = "engine";
        inherit extraPostFetch;
      };
    };
