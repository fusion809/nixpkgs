...
in {
  ...
  d2 = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "d2";
      rev = "68b08f28f4d9bae1f4f70005e97e2c74ba2e1e80";
      sha256 = "000412mkp44dcvdxwjgp0r34q60419fbfwpc6848s0wyypmzdp11";
    };
    engine = rec {
      version = "db487e1";
      mods = [ "cnc" "d2k" "ra" ];
  ...
  ss = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "MustaphaTR";
      repo = "sole-survivor";
      rev = "bb2debe4c81036fafbf7a3dabdbc9a9be3942e61";
      sha256 = "0gwch7bmwkz5n0ap2wpl7d65hc6wjyrxlz1yn6zib63p2vv6kk6d";
    };
