...
in {
  ...
  ra2 = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "ra2";
      rev = "74e99598867afd93e4fca1f1f2546764a65fe595";
      sha256 = "1rbvfflhr22fllp5xwybphzhw3nc8lkm8w02fxrz2g4mzlwkmjmn";
    };
    engine = rec {
      version = "817923b";
      src = fetchFromGitHub {
  ...
  raclassic = buildOpenRAMod {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "raclassic";
      rev = "f5a1b38b5ba29c45b3a699d8f036d9b7c7742027";
      sha256 = "19apdybcs1z9vqirkjz87qbgb0zhla9gghrgn2hjddm65wxph0i8";
    };
    engine = rec {
      version = "playtest-20190302";
      src = fetchFromGitHub {
        owner = "OpenRA";
        repo = "OpenRA" ;
        rev = "${version}";
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e8820695c2e0d097ece949e703424aac9593546c";
      sha256 = "0ihprkcpi550z1whbjfmj41vqndcqqh14wpw3qcm269vv83ai2vj";
    };
    engine = let commit = "5d28d40"; in {
      version = abbrevCommit commit;
      mods = [ "as" ];
      src = fetchFromGitHub {
        owner = "GraionDilach";
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "02qn56pbkg0b2rv45lnfcj3h5bq03xzf6lshlb4ai4xniy2srjdn";
        name = "engine";
        inherit extraPostFetch;
      };
    };
  ...
  sp = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      owner = "ABrandau";
      repo = "OpenRAModSDK";
      rev = "f0cdea0a73062e218b860899e3d50108c3bf3e79";
      sha256 = "0rgfhklfghmkkmpag0hwcf3nw7pzldmbjzr131cs250f1bang8ln";
    };
  ...
  yr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "cookgreen";
      repo = "yr";
      rev = "7b096a0efa2425edc274243aaa8885d652cf1ca0";
      sha256 = "0w5nq1qzzdk7yiyrq7a8qcm7h4rcwy28z7ar925jrrydg3bjfzfb";
    };
    engine = rec {
      version = "5d28d40";
      src = fetchFromGitHub {
