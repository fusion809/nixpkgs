...
in {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3a936c531e09fa18e8f717abb4b24f69fc2f7f99";
      sha256 = "0ymavx6cdf7v9g517xnpmgw7yycdbhilx9y9wklgykv5v1lrl4vc";
    };
  ...
  ss = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "MustaphaTR";
      repo = "sole-survivor";
      rev = "9c27955b587b30f80b48ba351964247de94e7b56";
      sha256 = "07wzi1v4s9xb8g9b3kgm1qaff1bqi26q6cw2gkka6cagi6jpkpqb";
    };
    engine = let commit = "269b261"; in {
      version = abbrevCommit commit;
      src = fetchFromGitHub {
        owner = "OpenRA";
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "18nvkpnd17kj8x5970aa0ngxsm60fbi2rs4i4lki3w16xc86wp69";
        name = "engine";
        inherit extraPostFetch;
      };
    };
