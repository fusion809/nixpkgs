...
in {
  ...
  d2 = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "d2";
      rev = "f077555bb681190d7de09c03f5226349a3cd3cbd";
      sha256 = "0g1xydpxg0gykfn02kwsiij2f93j0vi5ds9msrj0ljz8yv5bb63x";
    };
    engine = rec {
      version = "27cfa9b";
      mods = [ "cnc" "d2k" "ra" ];
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "63350d237a95cf806bd132eba81b61d8c83a85f9";
      sha256 = "0h9lhn28d5y09b8abj73dnb3fyr02lrzd1p52xiima88qmg0mhj6";
    };
  ...
  ss = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "MustaphaTR";
      repo = "sole-survivor";
      rev = "65515fbcc4ed9245bd1fabfe5bbc472d8acc69b6";
      sha256 = "1iccy7c7n318j8b63wa3wpgkcjr5d92vlyx7kbxpsncsisdqla7a";
    };
    engine = let commit = "2d654e0"; in {
      ...
      src = fetchFromGitHub {
        ...
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "1y5ksxc1jl8ndja7x2cli9z8ikv5kfaq81kd70v1gh02pf49h6k9";
        name = "engine";
        inherit extraPostFetch;
      };
    };
