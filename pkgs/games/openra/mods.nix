...
in {
  ...
  sp = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      owner = "ABrandau";
      repo = "OpenRAModSDK";
      rev = "4f084dd330eb31e0986bd4225e8b30f4766ba90c";
      sha256 = "10fz9yk4vpg7c72sggn88qb1c9bjqbaqazdj0zzli55vd5irz0w0";
    };
  ...
  yr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "cookgreen";
      repo = "yr";
      rev = "b18afd17c53ea43b7df15174186e45fc74099602";
      sha256 = "1cbj6yd9561wjc34vd5qrmypczrxqw5ac4xjh5139idnai8vfb0m";
    };
    engine = rec {
      version = "release-20180923";
      src = fetchFromGitHub {
