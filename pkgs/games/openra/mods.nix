...
in {
  ...
  d2 = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "d2";
      rev = "fed7997781512bfe757c28832932851f2ee174ee";
      sha256 = "07prfaxb45fbvdcf1lri0vag0r64libnd5r4pprnazbdv7ksprgr";
    };
    engine = rec {
      version = "SP-22-04-19";
      mods = [ "cnc" "d2k" "ra" ];
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e5bc060eeecc41636e1b4fecb3d1593f742c9d75";
      sha256 = "17ch7fha9ifq76wk6dgm5i5142r5f509mxlrrlnh3lirq9kr9v8y";
    };
  ...
  sp = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      owner = "ABrandau";
      repo = "OpenRAModSDK";
      rev = "de8eab6414c83943891d7df27756e066caf862ed";
      sha256 = "1b5k5a3ykgh3lpmbsyg6gqabsb13m97q9q53dwr8wgwva1507cws";
    };
