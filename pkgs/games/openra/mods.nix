...
in {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b66d8b5c4245f91717e23967c91f7cd06de8eefd";
      sha256 = "06rwzpdps01l18nhjb8cf4ri83yim949xhyp43ijj2gzpq274dg2";
    };
    engine = let commit = "7d70aa1"; in {
      version = abbrevCommit commit;
      mods = [ "as" ];
      src = fetchFromGitHub {
        owner = "GraionDilach";
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "1jqn0vhc13ni1jlc32wqa1wv1zgpk2qa4pyv1dyq49zirlirj2dd";
        name = "engine";
        inherit extraPostFetch;
      };
    };
  ...
  yr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "cookgreen";
      repo = "yr";
      rev = "078b31cef13efbf1b78a532a0471ffef4ca843cb";
      sha256 = "1ngkk84c56pc0pxk46ih9qxf6wkzmcvbm1vqgqznipp8swirwv21";
    };
    engine = rec {
      version = "7d70aa1";
      src = fetchFromGitHub {
