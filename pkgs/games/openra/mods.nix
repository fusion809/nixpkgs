...
in {
  ...
  ra2 = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "ra2";
      rev = "de0c192d7eebc18cc8d35663281c83963f4eb437";
      sha256 = "1y58rfhxwndddnkwg5gaj52qmdvq0qf8173alliz90nkgibrmj3n";
    };
    engine = rec {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "625d3eef08833d9c557915bd15dfdc970df06783";
      sha256 = "18k7acsw46hhbbgw24r8wi8xk7d4qpqiajgidysiakdmn23h961h";
    };
