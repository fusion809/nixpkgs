...
in {
  ...
  yr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "cookgreen";
      repo = "yr";
      rev = "be35c2552c0bdc8aa50009ef74eadc67be0d0ea5";
      sha256 = "1ngn66kjb9k8hi2nzagc18d146r6klwfiyr72xx1rc3bh4l4v8yv";
    };
    engine = rec {
      version = "f91d3f2603bbf51afaa89357e4defcdc36138102";
      src = fetchFromGitHub {
        owner = "OpenRA";
        repo = "OpenRA" ;
        rev = "${version}";
