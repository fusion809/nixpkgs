...
in {
  ...
  ra2 = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "OpenRA";
      repo = "ra2";
      rev = "8ba40d4c4b2f795c393958e14d2cd2421e91707d";
      sha256 = "115qp7c2lvpq13z8d2vz5mrfl3y869qx357xjrlwqwymfxxpbcgx";
    };
    engine = rec {
      version = "61922fe";
      src = fetchFromGitHub {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f36c5e94248c139d02f2ba986ef4560b1fa98f21";
      sha256 = "11r2dpnciaddbbjkn1j7kfa6wpff4zb1ha5rag829ydfckjmmcrz";
    };
    engine = let commit = "61922fe"; in {
      version = abbrevCommit commit;
      mods = [ "as" ];
      src = fetchFromGitHub {
        owner = "GraionDilach";
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "1a6gssx8bs5yvaafl1pfnhw645ginpq801sipwqs3i1llanvvwsg";
        name = "engine";
        inherit extraPostFetch;
      };
    };
  ...
  ss = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "MustaphaTR";
      repo = "sole-survivor";
      rev = "e5c1a91243659d72a41d244cc8273c0b7d1f0c37";
      sha256 = "0kp74rz18d7ynbllf3j3c41bl2p2n7yyvrx48z6kg5ly11fvcsh3";
    };
    engine = let commit = "5b61c3a"; in {
      version = abbrevCommit commit;
      src = fetchFromGitHub {
        owner = "OpenRA";
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "1zh5n5xk8v8lj81xcvyw7xdjsi9ayil8c4wj0p3fg5ksf94df0p4";
        name = "engine";
        inherit extraPostFetch;
      };
    };
