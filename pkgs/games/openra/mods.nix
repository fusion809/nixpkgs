...
in {
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "37caad679a30ed52c8330d6427d9ea082a1cdd44";
      sha256 = "141dvrvi7gqmpzsi15k7n62l7i5g084x3k0pbw4y73d2klcbxhph";
    };
  ...
  sp = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      owner = "ABrandau";
      repo = "OpenRAModSDK";
      rev = "614abc8dc47048c47975020966a86955d997410c";
  ...
  ss = buildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "MustaphaTR";
      repo = "sole-survivor";
      rev = "d335bb4d63c471eb1e5fe7efb40b23a1a8e4259e";
      sha256 = "0956v71flhw0xwraqylmy6acnmvd7d6918srbzq7vsg3sc6zv6hl";
    };
    engine = let commit = "83ab5a7"; in {
      version = abbrevCommit commit;
      src = fetchFromGitHub {
        owner = "OpenRA";
        repo = "OpenRA" ;
        rev = commit;
        sha256 = "0jgj1nkb412js2w6fxlsnqqxni66yn5s8f8gkzn96i3r8k2irc00";
        name = "engine";
        inherit extraPostFetch;
      };
    };
  ...
  yr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "cookgreen";
      repo = "yr";
      rev = "d8e1d63916ff9c3c3a19bd6851b88ace2cfe669b";
      sha256 = "1jvwnvlsclapdnr0anwjqflkqjw9qlbxc7ni1mqhjzrj53jfczmv";
    };
    engine = rec {
      version = "release-20190314";
      src = fetchFromGitHub {
