...
in {
  ...
  dr = unsafeBuildOpenRAMod rec {
    ...
    src = fetchFromGitHub {
      owner = "drogoganor";
      repo = "DarkReign";
      rev = "012acd08d67a995afe688268fbd9f09f72d51501";
      sha256 = "17xiszm2zvrazk72vr7dj84jpznar6bpagl3m6dk3bgjzq5pjm7r";
    };
  ...
  rv = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      ...
      rev = "4fa915b2b470190438146cefaafd445e959581a2";
      sha256 = "05i7bflchmdnm830xnxnjg76kvc9d4iiwkqfzfh5flr2gsjaha99";
    };
  ...
  sp = unsafeBuildOpenRAMod {
    ...
    src = fetchFromGitHub {
      owner = "ABrandau";
      repo = "OpenRAModSDK";
      rev = "c368e5dd8c82965363ec7a3c0de9d4584f298c3f";
      sha256 = "1k90imng034lqdz97j9zg0cngpli0dln0ap4rbjxcqv5s0dzqm0b";
    };
